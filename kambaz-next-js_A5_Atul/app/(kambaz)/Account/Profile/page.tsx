...
export default function Profile() {
  ...
  // New: update profile using client and update redux state
  ...
  const signout = async () => {
    // New: call backend signout if available, then clear redux and navigate
    try {
      await client.signout();
    } catch (err) {
      // ignore signout error and continue clearing client state
    ...
    >
      <div style={{ width: "350px" }}>
        ...
        <Button
          id="wd-update-btn"
          variant="primary"
          className="w-100 mb-2 text-decoration-none"
